...
const double _kInactiveFontSize = 14.0;
...
enum SelfBottomNavigationBarType {
...
class SelfBottomNavigationBar extends StatefulWidget {
  ...
  /// Defines the layout and behavior of a [BottomNavigationBar].
  ///
  /// See documentation for [SelfBottomNavigationBarType] for information on the meaning
  /// of different types.
  final SelfBottomNavigationBarType type;
  ...
  /// If [fixedColor] is null then the theme's primary color,
  /// [ThemeData.primaryColor], is used. However if [BottomNavigationBar.type] is
  /// [SelfBottomNavigationBarType.shifting] then [fixedColor] is ignored.
  ...
  Widget _buildIcon() {
    ...
    switch (type) {
      case SelfBottomNavigationBarType.fixed:
        ...
        break;
      case SelfBottomNavigationBarType.shifting:
        tweenStart = 16.0;
